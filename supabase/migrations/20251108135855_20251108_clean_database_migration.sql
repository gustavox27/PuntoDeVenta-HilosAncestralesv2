/*
  # Migración Limpia y Completa - HILOSdeCALIDAD

  Esta migración limpia y consolida el schema completo de la base de datos
  eliminando todas las configuraciones previas y recreando desde cero
  con la estructura definitiva.

  ## Acciones:
  1. Drop de todas las tablas y funciones existentes (preservando datos históricos si existen)
  2. Recreación completa del schema desde cero
  3. Índices optimizados
  4. RLS policies habilitadas
  5. Triggers y funciones de negocio
*/

-- =====================================================
-- LIMPIAR SCHEMA PREVIO
-- =====================================================
DROP TABLE IF EXISTS ventas_detalle CASCADE;
DROP TABLE IF EXISTS anticipos CASCADE;
...
DROP FUNCTION IF EXISTS actualizar_subtotal_con_descuento CASCADE;
DROP FUNCTION IF EXISTS actualizar_total_venta CASCADE;
DROP FUNCTION IF EXISTS actualizar_updated_at CASCADE;
DROP FUNCTION IF EXISTS actualizar_venta_desde_anticipos CASCADE;
DROP FUNCTION IF EXISTS marcar_ventas_usuario_eliminado CASCADE;
DROP FUNCTION IF EXISTS marcar_ventas_detalle_producto_eliminado CASCADE;
DROP FUNCTION IF EXISTS eliminar_venta_con_rollback CASCADE;
