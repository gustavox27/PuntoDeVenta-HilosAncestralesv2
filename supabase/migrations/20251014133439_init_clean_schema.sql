...
INSERT INTO eventos (tipo, descripcion, usuario, modulo, accion) VALUES
  ('Sistema', 'Base de datos inicializada con esquema completo y todos los campos necesarios', 'Sistema', 'Sistema', 'Inicialización')
ON CONFLICT DO NOTHING;