/*
  # Migración Unificada Completa - HILOSdeCALIDAD con Validación de Anticipos

  ## Resumen

  Este archivo consolida el esquema completo del sistema de gestión de inventario y ventas
  de HILOSdeCALIDAD con todas las tablas, índices, políticas de seguridad (RLS), triggers,
  funciones de negocio y validación de uso de anticipos.
  ...
  - Campos numero_guia en tabla ventas (obligatorio)
  ...
  - Función check_anticipo_usage para validar uso de anticipos
  - Índices optimizados para consultas frecuentes (17 índices totales)
  - Políticas RLS para control de acceso

  ## Seguridad

  - RLS habilitado en todas las 7 tablas
  - Políticas permisivas (basadas en confianza del sistema)
  - Función eliminar_venta_con_rollback con SECURITY DEFINER
  - Función check_anticipo_usage con SECURITY DEFINER y permisos de ejecución

  ## Funciones Incluidas

  1. actualizar_subtotal_con_descuento - Calcula subtotal con descuento
  2. actualizar_total_venta - Actualiza total de venta desde detalles
  ...
  5. marcar_ventas_usuario_eliminado - Marca ventas cuando se elimina usuario
  6. marcar_ventas_detalle_producto_eliminado - Marca detalles cuando se elimina producto
  7. eliminar_venta_con_rollback - Elimina venta restaurando stock y anticipos
  8. check_anticipo_usage - Valida si un anticipo ha sido utilizado
*/
...
-- =====================================================
-- FUNCIÓN: Check Anticipo Usage - Validación de Uso
-- =====================================================
