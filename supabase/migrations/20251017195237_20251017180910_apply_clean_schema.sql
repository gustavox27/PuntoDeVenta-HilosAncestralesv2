/*
  ...
  1. Nuevas Tablas
    - `usuarios` - Gestión de clientes y usuarios del sistema (con campo dirección)
  ...
  2. Campos Principales
    - usuarios.direccion - Dirección del cliente/usuario
...
-- Tabla usuarios con campo dirección
