  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
          className={`inline-block w-full max-w-lg p-0 my-8 overflow-hidden text-left align-middle transition-all transform ${
            isDark ? 'bg-gray-800' : 'bg-white'
          } shadow-2xl rounded-2xl`}
        >
          <div className={`px-6 py-5 border-b ${isDark ? 'border-gray-700 bg-red-950' : 'border-red-100 bg-red-50'}`}>
          ...
          <div className="px-6 py-6">
            <div className={`rounded-xl border-2 p-5 mb-6 ${
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className={`font-bold text-base mb-2 ${isDark ? 'text-red-400' : 'text-red-800'}`}>
                    Se eliminarán TODOS los datos
                  </h4>
                  <ul className={`text-sm space-y-2 ${isDark ? 'text-gray-300' : 'text-red-700'}`}>
            ...
            <div>
              <label className={`block text-sm font-bold mb-3 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>
                Para confirmar, escribe: <span className="text-red-600">{confirmationText}</span>
              </label>
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 rounded-xl border-2 font-mono text-center text-lg font-bold transition-all focus:outline-none ${
                    isDeleting
                      ? isDark
          ...
          <div className={`px-6 py-4 flex gap-3 border-t ${isDark ? 'border-gray-700 bg-gray-750' : 'border-gray-200 bg-gray-50'}`}>
            <button
              type="button"
              onClick={onClose}
              disabled={isDeleting}
