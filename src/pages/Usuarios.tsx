  ...
  const handleExportPDF = async () => {
    try {
      ...
      await ExportUtils.exportToPDF(
        ...
        'usuarios',
        'Lista de Usuarios - HILOS ANCESTRALES'
      );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          value={usuarios.filter(u => u.perfil === 'Cliente').length.toString()}
          icon={Users}
          color="bg-orange-500"
        />
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center group relative">
            ...
            <p className="text-lg font-bold text-green-600 mt-2">En Desarrollo</p>

            {/* AQUI SE AGREGA EL TOOL TIP <div className="absolute left-1/2 transform -translate-x-1/2 bottom-full mb-2 w-72 bg-gray-900 text-white text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-10">
              <p className="font-semibold mb-1">¿Cómo se calcula la Retención?</p>
              <p className="text-gray-300">
                La retención mide el porcentaje de clientes que han realizado más de una compra en el sistema.
                Se calcula dividiendo el número de clientes con 2 o más compras entre el total de clientes que
                han comprado al menos una vez.
              </p>
